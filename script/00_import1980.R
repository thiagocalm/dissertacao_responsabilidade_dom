...
ddi <- read_ipums_ddi("./dados/raw/ipumsi_00010.xml") # reading ddi
df_1980 <- read_ipums_micro(ddi) #reading data using ddi informations
...
df_1980 |> 
  save(file = "./dados/raw/censo_1980.RData")
