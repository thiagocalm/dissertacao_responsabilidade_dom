...
ddi <- read_ipums_ddi("./dados/raw/ipumsi_00009.xml") # reading ddi
df_1970 <- read_ipums_micro(ddi) #reading data using ddi informations
...
df_1970 |> 
  save(file = "./dados/raw/censo_1970.RData")
